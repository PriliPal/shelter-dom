<template>
  <section class="about-section">
    ...
    <div class="about-section-content">
      ...
      <h3 class="about-section-content-title">About the shelter “Cozy House”</h3>

      <span class="about-section-content-description">
      ...
      <span class="about-section-content-description">
          ...
          feel comfortable (including psychologically) and well.
    ...
    <img class="about-section-image" src="../../public/dog-cat-about.png" alt="dog&cat">
